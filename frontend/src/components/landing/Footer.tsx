  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { label: 'Therapy Types', href: '#therapies' },
        ...
        <div className="border-t border-gray-800 pt-8 mb-8">
          <div className="max-w-md">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Get the latest protocols, research, and platform updates.
            </p>
            <form className="flex gap-2">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-primary-500 transition-colors"
              />
              <button
                type="submit"
                className="px-6 py-2 bg-gradient-to-r from-primary-600 to-primary-500 text-white font-medium rounded-lg hover:from-primary-700 hover:to-primary-600 transition-all"
              >
                Subscribe
              </button>
            </form>
